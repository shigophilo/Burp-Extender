...
class BurpExtender(IBurpExtender, IScannerCheck, ITab):
    def registerExtenderCallbacks(self, callbacks):
        ...
        callbacks.setExtensionName("BurpJSLinkFinder-shi")
        ...
        self.log_file_name = "F:\\burplog\\js_link\\burp_js_linkfinder_%s.log" % current_date
        self.log_file = open(self.log_file_name, "a")
        self.log_file.write("Burp JS LinkFinder loaded.\nCopyright (c) 2019 Frans Hendrik Botes\n")
    ...
    def clearLog(self, event):
        ...
        self.log_file.write("Burp JS LinkFinder loaded.\nCopyright (c) 2019 Frans Hendrik Botes and TONGYl Lingma\n")
        ...
        try:
            ...
            if ".js" in str(urlReq):
                ...
                if any(x in testString for x in JSExclusionList):
                    ...
                    self.log_file.write("[-] URL excluded " + str(urlReq) + "\n")
                else:
                    self.outputTxtArea.append("\n" + "[+] Valid URL found: " + str(urlReq))
                    self.log_file.write("[+] Valid URL found: " + str(urlReq) + "\n")
                    ...
                    for counter, issueText in enumerate(issueText):
                            ...
                            self.log_file.write("\t" + str(counter)+' - ' +issueText['link'] + "\n")   
            ...
            self.log_file.write("Error in URL decode.\n")
        return None
